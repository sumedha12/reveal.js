...
function selfriends()
    ...
    $(".well").append("<button button class='btn btn-default' onClick = time() name= newbutton  id ="+i+"> "+doc.spec_friend[i]+" </button> <br><br>");          
    return doc;        
    }
   else{ 
    var len = doc.length;       
